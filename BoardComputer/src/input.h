...
typedef enum INPUT_COMPONENTID
{
	...
	INPUT_COMPONENT_MAINDISPLAY = 2 | (NEXTION_PAGEID_BOARD << 4),
	INPUT_COMPONENT_WATCH = 5 | (NEXTION_PAGEID_BOARD << 4),
	INPUT_COMPONENT_WATCHSEL = 6 | (NEXTION_PAGEID_BOARD << 4),
	INPUT_COMPONENT_CONFIG = 7 | (NEXTION_PAGEID_BOARD << 4),
