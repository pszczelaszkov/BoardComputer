...
static const Entryinfo entryinfo[CONFIG_ENTRY_LAST] PROGMEM = {
    ...
    CONFIG_ENTRY(COUNTERS_SIGNAL_PER_100M, ENTRY_VALIDATOR_POSITIVE_4DIGIT_EXCL_0),
    CONFIG_ENTRY(COUNTERS_INJECTORS_CCM, ENTRY_VALIDATOR_POSITIVE_4DIGIT_EXCL_0),
    ...
    CONFIG_ENTRY(BOARD_DELTA_THRESHOLD, ENTRY_VALIDATOR_ENUM_3),
};
...
void CONFIG_factory_default_reset()
{
    ...
    {
        if(CONFIG_ENTRY_COUNTERS_INJECTORS_CCM == i 
            || CONFIG_ENTRY_COUNTERS_SIGNAL_PER_100M == i 
